...
public class SqlTypeChecker {
	...
	return SqlParseHelper.removeSqlComments(sourceSql).trim().toLowerCase()
		.matches("(?is)\\s*select\\s.*\\sfrom\\s+.*");
    }
