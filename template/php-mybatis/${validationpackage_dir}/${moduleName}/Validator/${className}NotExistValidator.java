...
public class ${className}NotExistValidator{
<#assign columnX=''>
...
<#if x!="">
    ...
    public static class ${className}NotExistValidator${x} implements ConstraintValidator<${className}ParameterNotExistAnnotation,${x}>{
        @Autowired
