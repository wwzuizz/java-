...
import ${validationpackage}.${moduleName}.Validator.${className}NotExistValidator;
...
@Retention(RUNTIME)
@Constraint(validatedBy ={<#list columnX?split("-")as x><#if x!="">${className}NotExistValidator.${className}NotExistValidator${x}.class,</#if></#list>})
@Documented
public @interface ${className}ParameterNotExistAnnotation {

	String message() default "{${className}ParameterNotExistAnnotation}}";
